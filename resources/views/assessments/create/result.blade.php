...
<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-semibold text-body dark:text-slate-100">{{ $isRetake ? 'Retake: Review AI Classification' : 'Step 3: Review AI Classification' }} &mdash; {{ $student->full_name }}</h2>
    </x-slot>
