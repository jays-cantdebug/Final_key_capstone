<x-guest-layout>
    <div class="rounded-3xl bg-white p-8 shadow-[0_20px_60px_rgba(31,107,58,0.12)] ring-1 ring-black/5">
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            <a href="{{ route('login') }}" class="rounded-xl bg-[#1F6B3A] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-[#1F6B3A]/20 hover:bg-[#185828]">
                Sign in
            </a>
        </div>
    </div>
