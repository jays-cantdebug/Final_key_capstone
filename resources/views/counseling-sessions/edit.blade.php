<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="text-2xl font-semibold text-body dark:text-slate-100">Edit Session</h2>
            </div>
    ...
    <x-card>
        <div class="border-b border-slate-200 pb-6">
            ...
            <h3 class="mt-2 text-xl font-semibold text-body dark:text-slate-100">{{ $session->student->full_name }}</h3>
